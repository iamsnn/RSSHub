...
const calculateValue = () => {
    ...
    value = {
        ...
        twitter: {
            consumer_key: 'EFGYuB55d3ntzEBR8BZe56dCN',
            consumer_secret: 'F1csJpVJNtFUr0OfdEfyhxLOpmFKGFrJSFjRtFNsVXnIw25HDO',
            tokens: 'AAAAAAAAAAAAAAAAAAAAAJhELgEAAAAAACKXbMJLijmVmWwgNi18GUcaE50%3DZOaKvvXvnZ7iBpKQDd17qM4UEuYEnwvNljKX9HLaCx3JCp9qw6',
        },
        youtube: {
            key: 'AIzaSyA2swHxIV7JhwLg5LiykSqtWSKvEC0udUk',
        },
        telegram: {
